...
export const bot = portfolio.table('bot', {
  ...
  user_designation: text('user_designation').notNull().default('teacher'),
...
export const department_teachers = portfolio.table('department_teachers', {
  ...
  teacher_designation: text('teacher_designation').notNull().default('teacher'),
  teacher_phone: text('teacher_phone').notNull().default('01700000000'),
  teacher_email: text('teacher_email').notNull().default('eub@eub.com'),
...
export const club = portfolio.table('club', {
  ...
  president_phone: text('president_phone').notNull().default('01700000000'),
...
export const office_entry = portfolio.table('office_entry', {
  ...
  user_phone: text('user_phone').notNull().default('01700000000'),
