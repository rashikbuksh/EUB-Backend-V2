...
export const department = portfolio.table('department', {
  ...
  uuid: uuid_primary,
  name: text('name').notNull(),
  short_name: department_short_name('short_name').notNull().unique(),
...
export const teachers = portfolio.table('teachers', {
  id: integer('id').default(sql`nextval('portfolio.teachers_id')`),
  uuid: uuid_primary,
...
export const department_teachers = portfolio.table('department_teachers', {
  ...
  teachers_uuid: defaultUUID('teachers_uuid').notNull().references(() => teachers.uuid, DEFAULT_OPERATION),
  department_head: boolean('department_head').default(false),
  department_head_message: text('department_head_message').notNull(),
  teacher_designation: text('teacher_designation').notNull(),
  status: boolean('status').default(false),
  created_at: DateTime('created_at').notNull(),
  updated_at: DateTime('updated_at'),
  created_by: defaultUUID('created_by').references(() => users.uuid, DEFAULT_OPERATION),
...
export const news = portfolio.table('news', {
  ...
  department_uuid: defaultUUID('department_uuid').references(() => department.uuid, DEFAULT_OPERATION),
...
export const feature_type_enum = portfolio.enum('feature_type_enum', [
  'article',
  'hero',
]);
...
export const feature = portfolio.table('feature', {
  ...
  description: text('description').notNull(),
  file: text('file'),
  type: feature_type_enum('type').default('article'),
...
export const portfolio_teachers_rel = relations(teachers, ({ one }) => ({
  teacher: one(users, {
    fields: [teachers.teacher_uuid],
    references: [users.uuid],
  }),
  created_by: one(users, {
